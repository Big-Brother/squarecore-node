...
var squarecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = squarecorenode.version;
  var create = squarecorenode.scaffold.create;
  var add = squarecorenode.scaffold.add;
  var start = squarecorenode.scaffold.start;
  var remove = squarecorenode.scaffold.remove;
  var callMethod = squarecorenode.scaffold.callMethod;
  var findConfig = squarecorenode.scaffold.findConfig;
  var defaultConfig = squarecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the square database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make squarecore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `squarecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ squarecore-node add wallet-service');
      console.log('    $ squarecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ squarecore-node remove wallet-service');
      console.log('    $ squarecore-node remove insight-api');
      console.log();
    });
