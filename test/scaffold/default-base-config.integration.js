...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    squared.spawn.datadir.should.equal(home + '/.square');
    squared.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.square/squared'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.squared.spawn.datadir.should.equal('./data2');
  });
});
