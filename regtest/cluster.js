...
describe('Square Cluster', function() {
  ...
  var nodesConf = [
    {
      ...
      conf: path.resolve(__dirname, './data/node1/square.conf'),
      rpcuser: 'square',
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node2/square.conf'),
      rpcuser: 'square',
      rpcpassword: 'local321',
      rpcport: 30522,
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node3/square.conf'),
      rpcuser: 'square',
      rpcpassword: 'local321',
      rpcport: 30523,
  ...
  before(function(done) {
    log.info('Starting 3 squared daemons');
    this.timeout(200000);
  ...
  it('step 1: will connect to three squared daemons', function(done) {
    this.timeout(20000);
    var configuration = {
      network: 'regtest',
      services: [
  ...
  it('step 2: receive block events', function(done) {
    this.timeout(10000);
    node.services.squared.once('tip', function(height) {
